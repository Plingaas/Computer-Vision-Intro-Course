...
def find_corners(gray_image):
    # TODO: Use cv2.goodFeaturesToTrack(). Try maxCorners=100,
    # qualityLevel=0.01, minDistance=10. Return the detected corners.
    raise NotImplementedError("Find Shi–Tomasi corners")
...
def draw_corners(image, corners):
    ...
    for point in corners:
        ...
        # TODO: Draw a small filled circle at (x, y) using cv2.circle().
        # Hint: BGR green is (0, 255, 0); thickness=-1 fills a circle.
        raise NotImplementedError("Mark each corner")
    return result
